...
namespace Infrastructure.Repositories
{
    public class TokensRepository : ITokenRepository
    {
        ...
        {
            var query = "INSERT INTO [Licenta].[Tokens] ([UserEmail], [Token], [ExpirationDate]) VALUES (@UserEmail, @Token, @ExpirationDate)";
        ...
        {
            var sql = "SELECT [UserEmail], [Token], [ExpirationDate] FROM [Licenta].[Tokens] WHERE [Token] = @Token";
