...
namespace Infrastructure.Repositories
{
    public class FeedbackRepository : IFeedbackRepository
    {
        ...
        {
            var query = @"INSERT INTO [Licenta].[Feedback] ([Feedback_name], [Feedback_email], [Feedback_description], [Feedback_title], [Feedback_anonymus], [Feedback_stars], [Feedback_category])
                          VALUES (@FeedbackName, @FeedbackEmail, @FeedbackDescription, @FeedbackTitle, @FeedbackAnonymus, @FeedbackStars, @FeedbackCategory)";
        ...
        {
            var queryStart = @"SELECT [Feedback_name] AS Name, [Feedback_email] AS Email, [Feedback_description] AS Content, [Feedback_title] AS Title, [Feedback_category] AS CategoryString, [Feedback_anonymus] AS IsAnonymus, [Feedback_stars] AS Stars, [Feedback_date] AS Date 
                               FROM [Licenta].[Feedback]";
